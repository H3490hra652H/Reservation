...
MAIN_ROOM_FLOOR_TABLES = [
    {
        ...
        "capacity": 4,
        "sort_order": 10,
        "description": "Dekat AC dan area live music.",
    },
    {
    ...
    },
    {
        ...
        "capacity": 4,
        "sort_order": 30,
        "description": "Dekat AC dan koridor tengah.",
    },
    {
        ...
        "capacity": 4,
        "sort_order": 40,
        "description": "Dekat AC dan akses ke toilet.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 50,
        "description": "Sisi kiri dekat live music.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 60,
        "description": "Sisi kiri dekat jendela utama.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 70,
        "description": "Sisi kiri dekat koridor bar.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 80,
        "description": "Sisi kiri dekat bar dan waiting area.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 90,
        "description": "Tengah atas, dekat AC.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 100,
        "description": "Tengah atas, pasangan Meja 5.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 110,
        "description": "Tengah atas, dekat toilet.",
    },
    {
        ...
        "capacity": 2,
        "sort_order": 120,
        "description": "Tengah atas, akses dekat wastafel.",
    },
    {
    ...
    },
    {
        ...
        "capacity": 4,
        "sort_order": 150,
        "description": "Area tengah utama, dekat sofa.",
    },
    {
        ...
        "capacity": 4,
        "sort_order": 160,
        "description": "Tengah kanan dekat sofa.",
    },
    {
        ...
        "capacity": 4,
        "sort_order": 170,
        "description": "Tengah bawah dekat kasir.",
    },
    {
        ...
        "capacity": 4,
        "sort_order": 180,
        "description": "Tengah bawah dekat sofa/waiting area.",
    },
]
...
def ensure_reservation_floor_schema(cursor):
    ...
    cursor.execute("SELECT resource_code FROM restaurant_tables")
    existing_floor_codes = {str(row.get("resource_code")).strip() for row in cursor.fetchall()}

    cursor.execute("SELECT resource_code FROM booking_resources")
    existing_booking_codes = {str(row.get("resource_code")).strip() for row in cursor.fetchall()}

    for table in MAIN_ROOM_FLOOR_TABLES:
        if table["resource_code"] not in existing_floor_codes:
            cursor.execute(
                """
        ...
        if table["resource_code"] not in existing_booking_codes:
            cursor.execute(
                """
